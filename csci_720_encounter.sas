...
/* ------------------------------------------------------------------------- */
/* #13. How to concat strings? */

/* ------------------------------------------------------------------------- */
/* #14. How to check if a dataset exists? */

/* ------------------------------------------------------------------------- */
/* #15. How to check if a file exists? */

/* ------------------------------------------------------------------------- */
/* #16. How to move/copy/delete a file using sysexec? */

/* ------------------------------------------------------------------------- */
/* #17. How to create a folder using option, if it doesn't exits */

/* ------------------------------------------------------------------------- */
/* #18. How to send an email? */
